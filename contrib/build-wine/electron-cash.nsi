...
;General
  ...
  VIAddVersionKey LegalCopyright "2013-2025 ${PRODUCT_PUBLISHER} and Electrum Technologies GmbH"
...
Section
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Chipnet.lnk" "$INSTDIR\${INTERNAL_NAME}.exe" "--chipnet" "$INSTDIR\${INTERNAL_NAME}.exe" 0
